...
public class ButtonTest extends Component<Props, State> {
    public ButtonTest(Props props) {
        super(props);
    }

    public static void testButton() throws Exception {
        ReactElement<ButtonTest> createElement = React.createElement(ButtonTest.class, null);
...
//              );
//
//              ReactDOM.render(ReactElement.c, arg1)
//              return <ButtonsTest />
    ...
    public ReactElement<?> render() {
        ...
        ReactElement<?> div = div(null, createElement(Button.class, props2), createElement(Button.class, props1), createElement(Button.class, props3), createElement(Button.class, props4), createElement(IconButton.class, props5), createElement(Button.class, props6));
        return div;
    }
